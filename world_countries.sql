...
(203, 'CZ', 'CZE', 'Czech Republic', 'Tschechien', 'República Checa', 'République tchèque', '.cz'),
...
(807, 'MK', 'MKD', 'Macedonia', 'Mazedonien', 'Macedonia', 'Macédoine', '.mk'),
...
(748, 'SZ', 'SWZ', 'Swaziland', 'Swasiland', 'Suazilandia', 'Swaziland', '.sz'),
...
(336, 'VA', 'VAT', 'Vatican City', 'Vatikanstadt', 'Vaticano, Ciudad del', 'Saint-Siège (État de la Cité du Vatican)', '.va'),
