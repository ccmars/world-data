...
csv2xlsx('src/data/world_countries.csv', 'dist/xlsx/world_countries.xlsx', 'World Countries (ISO 3166)')
csv2xlsx('src/data/world_currencies.csv', 'dist/xlsx/world_currencies.xlsx', 'World Currencies (ISO 4217)')
csv2xlsx('src/data/world_languages.csv', 'dist/xlsx/world_languages.xlsx', 'World Languages (ISO 639)')